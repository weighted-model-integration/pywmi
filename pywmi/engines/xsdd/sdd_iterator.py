...
:author: Wannes Meert, Arthur Choi, Samuel Kolb
...
class SddIterator:
    ...
    def depth_first(self, node, func):
        ...
        ``rvalue = func(node, [(prime_rvalue, sub_rvalue, prime_vars, sub_vars)],
                        expected_prime_vars, expected_sub_vars, prime, sub)``
    ...
    def depth_first_rec(self, node, func):
        ...
        if node.is_decision():
            ...
            for prime, sub in node.elements():
                ...
                rvalues.append((wmc_prime, wmc_sub, used_prime_vars, used_sub_vars, prime, sub))
